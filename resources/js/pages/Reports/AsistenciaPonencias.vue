...
<template>
    ...
    >
        <Head title="Asistencia a Ponencias" />
        ...
        <div class="mx-auto min-h-screen w-full max-w-7xl space-y-6 px-8 py-8">
            <div class="flex items-center justify-between">
                ...
                <a
                    href="/admin/reportes/export/asistencia-ponencias"
                ...
                <div class="overflow-x-auto">
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <td
                                    class="max-w-xs truncate px-6 py-4 text-sm font-medium text-gray-900 dark:text-white"
                                >
                                    {{ p.title }}
                                </td>
                                <td
