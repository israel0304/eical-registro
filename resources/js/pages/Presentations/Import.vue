    ...
    <AppLayout :breadcrumbs="[
        ...
        <div class="mx-auto min-h-screen w-full max-w-4xl space-y-6 px-8 py-8">
            ...
            <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm dark:border-zinc-800 dark:bg-zinc-900">
                <div class="space-y-6">
                    <div>
                        <h3 class="text-sm font-semibold text-gray-900 dark:text-white">Formato esperado</h3>
                        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                            El archivo CSV debe contener las columnas del sistema académico (OJS). Se importarán automáticamente:
                        </p>
                        <ul class="mt-2 list-inside list-disc text-sm text-gray-600 dark:text-gray-400">
                            ...
                            <li>Cada autor se crea como usuario con rol "Ponente"</li>
                        </ul>
                    </div>
                    ...
                    <div class="flex justify-end border-t border-gray-100 pt-4 dark:border-zinc-800">
                        <button
                            @click="submitImport"
