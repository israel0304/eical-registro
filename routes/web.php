...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('constancias/invitacion/conferencia/{conference}/download', [ConstanciaController::class, 'downloadInvitacionConferencia'])->middleware('can:constancias.download')->name('constancias.invitacion.conferencia.download');
